...
class Happiness(db.Model):
    ...
    # id = db.Column(db.Integer, primary_key=True) # These columns exist in the database
    # emoji_char = db.Column(db.String) # These are getting mirrored in
    # emoji_id = db.Column(db.String)
    # name = db.Column(db.String)
    # score = db.Column(db.Integer)

    index = db.Column(db.Integer, primary_key=True) # These columns exist in the database
    Year = db.Column(db.Integer) # These are getting mirrored in
    Country = db.Column(db.String)
    #"Happiness Rank" = db.Column(db.Integer)
    # "Happiness Score" = db.Column(db.Double)
    # "Economy GDP per capita" = db.Column(db.Double)
    Family = db.Column(db.Float)
    # "Health Life Expectancy" = db.Column(db.Double)

    def __repr__(self): # Prints out on terminal this information
        return '<Happ %r>' % (self.name)
...
The below are three ways to do the same thing
